  ...
  return (
    ...
    <div className="flex flex-col overflow-hidden w-full items-center justify-center pt-3 my-3 border bg-white/50 backdrop-blur-md shadow-md p-4 py-5 rounded-2xl">
      ...
      <div className="w-full   flex flex-col lg:flex-row gap-[10px] justify-evenly xl:justify-center items-center">
        {/* Box 1 */}
        <div className="rounded-xl shadow p-4 flex flex-col items-center justify-between w-full max-w-xs md:h-[200px] h-[190px]   bg-gradient-to-t  from-green-100  to-green-200 ">
        ...
        {/* Box 2 */}
        <div  className="rounded-xl shadow p-4 flex flex-col   items-center justify-between w-full max-w-xs md:h-[200px] h-[190px]    bg-gradient-to-t from-green-900 via-green-800 to-green-700">
        ...
        {/* Box 3 */}
        <div className="rounded-xl shadow p-4 flex flex-col items-center justify-between w-full max-w-xs md:h-[200px] h-[190px]   bg-gradient-to-t from-green-50  to-green-100">
      ...
      <p className="text-gray-800   text-center  text-base">
         ...
         <p className="md:leading-loose lg:leading-loose pl-5 pr-5 font-modam text-right w-full  text-base  ">   در این محله پایین ارزیابی می‌شود خصوصا در طولانی مدت ؛ به دلیل تقاضا بالا، روند توسعه و ساخت‌وساز در محله ، تعداد زیاد زمین‌های بایر و موقعیت مناسب شهری همراه با امکانات محله را دارد.
           </p>
      </p>
      </div>
    </div>
