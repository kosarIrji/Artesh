...
export default function SideBar() {
  ...
  return (
    <>
      ...
      {/* سایدبار دسکتاپ */}
      <aside className="hidden md:flex fixed top-0 right-0 h-full w-56 bg-[var(--sidebar)] shadow-xl z-[1000] flex-col items-center py-1">
        <div className="mb-2">
              ...
              <li key={item.id}>
                {item.external ? (
                  <a
                    ...
                    className="flex flex-row-reverse items-center justify-end gap-2 text-right font-bold text-white hover:text-[var(--text)] hover:bg-gray-100 rounded-lg px-3  transition-all cursor-pointer"
                  >
