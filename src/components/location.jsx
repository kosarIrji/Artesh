      ...
      {windowHeight < 500 ? (
        ...
        >
          ...
          <p className="md:leading-loose lg:leading-loose font-modam  text-justify text-base  ">
            محله ارتش در شمال غربی شهر بجنورد در منطقه 2 شهرداری واقع شده است و
            م وقعیتی مناسب نسبت به شهر دارد بطوریکه که از شمال به بلوار 32 متری
            ، از جنوب به خیابان طالقانی غربی و از سمت شرق و غرب نیز به ترتیب با
            محلات شریعتی شمالی و کوی معلم همجواری دارد که نشان دهنده موقعیت
            بسیار خوب محله در شهر میباشد.
          </p>
        </motion.div>
      ) : (
        ""
